...
namespace ValidicCSharp.Model
{
    ...
    /// <example>
    ///  "name": "BodyMedia",
    ///  "sync_url": "https://app.validic.com/organizations/51aca5a06dedda916400002b/auth/bodymedia?user_token=USERTOKEN&format_redirect=json",
    ///  "unsync_url": "",
    ///  "refresh_url": "",
    ...
    ///  "extra_excerpt": "It's a lot easier to treat everyone as if they're exactly the same. Other body monitoring systems do just that. Easier? Yes. More accurate? No. At BodyMedia, we're driven by facts and how they can help you.",
    ///  "subname": "bodymedia",
    ///  "kind": [
    ///      "fitness",
    ///      "nutrition",
